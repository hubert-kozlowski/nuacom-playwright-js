/*
 * Created by sergiutoma on 03/04/15.
 *
 * google LibPhoneNumber extended utilit
 */
...
var LPN = {
	...
	countryForE164Number: function (phone) {
		try {
			var phone = LPN.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
	...
	isValidLandline: function (phone, country) {
		try {
			var phone = LPN.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parseAndKeepRawInput(phone, country);
			...
			if (phoneUtil.getNumberType(number) === PNT.FIXED_LINE) {
				return true;
			}
			else {
				return false;
	...
	isValidMobile: function (phone, country) {
		try {
			var phone = LPN.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parseAndKeepRawInput(phone, country);
	...
	isValidForRegion: function (phone, country) {
		try {
			var phone = LPN.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parseAndKeepRawInput(phone, country);
			return (phoneUtil.isValidNumberForRegion(number, country)) ? true : false;
		} catch (e) {
			return false;
		}
	},
	...
	/*
	 ...
	 phone (String) phone number to format
	 */
	formatLocal: function (phone, country, spaces) {
		spaces = (typeof spaces !== 'undefined') ? spaces : false;
		try {
			var phone = LPN.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parseAndKeepRawInput(phone, country);
			if (phoneUtil.isValidNumberForRegion(number, country)) {
				...
				output = (spaces === true) ? output : LPN.cleanPhone(output);
				return output.toString();
			} else {
				return LPN.formatInternational(country, phone);
			}
		} catch (e) {
			return LPN.formatInternational(country, phone);
		}
	...
	/*
	 ...
	 phone (String) phone number to format
	 */
	formatInternational: function (phone, country, spaces) {
		spaces = typeof spaces !== 'undefined' ? spaces : false;
		try {
			var clean_phone = this.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parseAndKeepRawInput(clean_phone, country);
			var PNF = i18n.phonenumbers.PhoneNumberFormat;
			var output = new goog.string.StringBuffer();
			output = phoneUtil.format(number, PNF.INTERNATIONAL);
			output = output.toString();
			output = (spaces === true) ? output : this.cleanPhone(output);
			return output;
		} catch (e) {
			return false;
		}
	...
	getInternationalNumber: function(row_number, country){
		try{
			var phone = this.cleanPhone(row_number);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			if(phone){
				var number = phoneUtil.parseAndKeepRawInput(phone, country);
				if(!this.isValidNumber(number) && country){
					if(this.isValidNumber(phone, country)){
						var PNF = i18n.phonenumbers.PhoneNumberFormat;
						var output = new goog.string.StringBuffer();
						output = phoneUtil.format(number, PNF.E164);
						return output.toString();
						...
						// console.log('phoneUtil.isValidNumber(number, country)-', phone, country, phoneUtil.isValidNumber(number, country))
						return phone;
					}
				}
				else{
			...
			// console.log('e-', row_number, typeof row_number, e)
			return false;
		}
	},
	

	formatNumberTo: function(phone, format) {
		// country = typeof country !== 'undefined' ? country : false;
		try {
			var phone = this.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parse(phone);
//			console.log('formatE164_number:', number.getNationalNumber());
			var PNF = i18n.phonenumbers.PhoneNumberFormat;
			formatType = PNF.E164;
			if(format === 'NATIONAL'){
			...
			var output = new goog.string.StringBuffer();
			output = phoneUtil.format(number, formatType);
			return output.toString();
		} catch (e) {
			return phone;
		}
	...
	doubleZeroNumber: function(number){
	...
	getNumberFormatedE164: function(phone, country, spaces) {
		try {
			var clean_phone = this.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parseAndKeepRawInput(clean_phone, country);
			...
			output = phoneUtil.format(number, PNF.E164);
			output = output.toString();
			output = (spaces) ? output : this.cleanPhone(output);
			return output;
		} catch (e) {
			return false;
		}
	...
	getNumberFormatedInt: function(phone, country, spaces) {
		try {
			var clean_phone = this.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parseAndKeepRawInput(clean_phone, country);
			...
			output = output.toString();
			output = (spaces) ? output : this.cleanPhone(output);
			output = this.doubleZeroNumber(output);
			return output;
		} catch (e) {
			return false;
		}
	...
	getNumberFormatedNat: function(phone, country, spaces) {
		try {
			var clean_phone = this.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parseAndKeepRawInput(clean_phone, country);
	...
	getNumberFormatedLocalBare: function(phone, country){
		try {
			var clean_phone = this.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parseAndKeepRawInput(clean_phone, country);
	...
	compareNumbers: function(number1, number2, country){
		...
		var nr1_inter = this.getNumberFormatedE164(number1, country);
		var nr2_inter = this.getNumberFormatedE164(number2, country);
		// compare international format
		if(nr1_inter && nr2_inter && (nr1_inter === nr2_inter) ){
			return true;
		}
		return false;
	},
	
	testNR: function(phone, country){
		console.log('Phone: ', this.cleanPhone(phone));
		console.log('National: ', this.formatNumberTo(phone, 'NATIONAL'));
		console.log('NationalClean: ', this.cleanPhone(this.formatNumberTo(phone, 'NATIONAL')));
		console.log('FormatLocal: ', this.formatLocal(phone, country));
		console.log('FormatE164: ', this.formatNumberTo(phone));
		console.log('International: ', this.formatInternational(phone, country));
		console.log('getInternationalNumber: ', this.getInternationalNumber(phone, country));
		console.log('getNumberFormatedE164: ', this.getNumberFormatedE164(phone, country));
		console.log('getNumberFormatedInt: ', this.getNumberFormatedInt(phone, country));
		console.log('getNumberFormatedNat: ', this.getNumberFormatedNat(phone, country));
		console.log('getNumberFormatedLocalBare: ', this.getNumberFormatedLocalBare(phone, country));
		...
		try {
			var number = PNU.parse(phone, country);
			console.log('number_country: ', number.getCountryCode());
			console.log('number_local: ', number.getNationalNumber());
//			console.log('number: ', number);
	 ...
	 */
	formatNumberForMobileDialing: function (phone, country) {
		try {
			var phone = LPN.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parseAndKeepRawInput(phone, country);
	...
	getCountryCode: function (phone, country) {
		try {
			var phone = LPN.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parseAndKeepRawInput(phone, country);
	...
	getNationalNumber: function (phone, country) {
		try {
			var phone = LPN.cleanPhone(phone);
			var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
			var number = phoneUtil.parseAndKeepRawInput(phone, country);
	...
	getCountryISO: function (phone, country) {
		try {
			var phone = LPN.cleanPhone(phone);
			var countryISO = LPN.countryForE164Number(LPN.formatE164(phone, country));
			countryISO = (countryISO.lenght != 0) ? countryISO : false;
			return countryISO;
		} catch (e) {
			return false;
		}
	...
	countryISOArray: function() {
		...
		{ iso: "CO", name: "Columbia" },
		{ iso: "KM", name: "Comoros" },
		{ iso: "CG", name: "Congo" },
		{ iso: "CK", name: "Cook Islands" },
		{ iso: "CR", name: "Costa Rica" },
		{ iso: "CI", name: "Cote D'Ivorie (Ivory Coast)" },
		{ iso: "HR", name: "Croatia (Hrvatska)" },
		{ iso: "CU", name: "Cuba" },
		{ iso: "CY", name: "Cyprus" },
		{ iso: "CZ", name: "Czech Republic" },
		{ iso: "CD", name: "Democratic Republic Of Congo (Zaire)" },
		{ iso: "DK", name: "Denmark" },
		...
		{ iso: "GY", name: "Guyana" },
		{ iso: "HT", name: "Haiti" },
		{ iso: "HM", name: "Heard And McDonald Islands" },
		...
		{ iso: "SK", name: "Slovak Republic" },
		{ iso: "SI", name: "Slovenia" },
		{ iso: "SB", name: "Solomon Islands" },
		{ iso: "SO", name: "Somalia" },
		{ iso: "ZA", name: "South Africa" },
		{ iso: "GS", name: "South Georgia And South Sandwich Islands" },
	...
	countryCodeToName: function (countryCode) {
		var countryName = '';
		var ca = LPN.countryISOArray();

		for(var country in ca) {
			if(ca[country].iso === countryCode.toUpperCase()){
	...
	/*
	 Convert the country dial code to a country ISO code
	*/
	getCountryIsoCodeFromDialCode: function (phoneNumber) {
		var phoneNumberUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
		var phoneNumberObject = phoneNumberUtil.parse(phoneNumber)

		var iso = phoneNumberUtil.getRegionCodeForNumber(phoneNumberObject);

		return iso ? iso.toLowerCase() : ''
	},
	
	
	getAllCountrytries: function(){
		return [
			{ "name": "Afghanistan", "dialCode": "93", "iso2": "AF" },
			{ "name": "Åland Islands", "dialCode": "358", "iso2": "AX" },
			{ "name": "Albania", "dialCode": "355", "iso2": "AL" },
			{ "name": "Algeria", "dialCode": "213", "iso2": "DZ" },
			{ "name": "American Samoa", "dialCode": "1684", "iso2": "AS" },
			...
			{ "name": "Antigua and Barbuda", "dialCode": "1268", "iso2": "AG" },
			...
			{ "name": "Cayman Islands", "dialCode": "345", "iso2": "KY" },
			...
			{ "name": "Dominican Republic", "dialCode": "1849", "iso2": "DO" },
			...
			{ "name": "Falkland Islands (Malvinas)", "dialCode": "500", "iso2": "FK" },
			...
			{ "name": "French Guiana", "dialCode": "594", "iso2": "GF" },
			{ "name": "French Polynesia", "dialCode": "689", "iso2": "PF" },
			{ "name": "French Southern Territories", "dialCode": "262", "iso2": "TF" },
			...
			{ "name": "Guadeloupe", "dialCode": "590", "iso2": "GP" },
			...
			{ "name": "Heard Island and Mcdonald Islands", "dialCode": "0", "iso2": "HM" },
			{ "name": "Holy See (Vatican City State)", "dialCode": "379", "iso2": "VA" },
			...
			{ "name": "Iran, Islamic Republic of Persian Gulf", "dialCode": "98", "iso2": "IR" },
			...
			{ "name": "Korea, Democratic People's Republic of Korea", "dialCode": "850", "iso2": "KP" },
			{ "name": "Korea, Republic of South Korea", "dialCode": "82", "iso2": "KR" },
			...
			{ "name": "Libyan Arab Jamahiriya", "dialCode": "218", "iso2": "LY" },
			...
			{ "name": "Martinique", "dialCode": "596", "iso2": "MQ" },
			...
			{ "name": "Micronesia, Federated States of Micronesia", "dialCode": "691", "iso2": "FM" },
			...
			{ "name": "Montserrat", "dialCode": "1664", "iso2": "MS" },
			...
			{ "name": "Norfolk Island", "dialCode": "672", "iso2": "NF" },
			{ "name": "Northern Mariana Islands", "dialCode": "1670", "iso2": "MP" },
			...
			{ "name": "Palestinian Territory, Occupied", "dialCode": "970", "iso2": "PS" },
			...
			{ "name": "Puerto Rico", "dialCode": "1939", "iso2": "PR" },
			...
			{ "name": "Saint Helena, Ascension and Tristan Da Cunha", "dialCode": "290", "iso2": "SH" },
			{ "name": "Saint Kitts and Nevis", "dialCode": "1869", "iso2": "KN" },
			...
			{ "name": "Saint Vincent and the Grenadines", "dialCode": "1784", "iso2": "VC" },
			...
			{ "name": "South Georgia and the South Sandwich Islands", "dialCode": "500", "iso2": "GS" },
			...
			{ "name": "Syrian Arab Republic", "dialCode": "963", "iso2": "SY" },
			{ "name": "Taiwan", "dialCode": "886", "iso2": "TW" },
			{ "name": "Tajikistan", "dialCode": "992", "iso2": "TJ" },
			{ "name": "Tanzania, United Republic of Tanzania", "dialCode": "255", "iso2": "TZ" },
			...
			{ "name": "Turks and Caicos Islands", "dialCode": "1649", "iso2": "TC" },
			...
			{ "name": "Venezuela, Bolivarian Republic of Venezuela", "dialCode": "58", "iso2": "VE" },
			{ "name": "Vietnam", "dialCode": "84", "iso2": "VN" },
			{ "name": "Virgin Islands, British", "dialCode": "1284", "iso2": "VG" },
			{ "name": "Virgin Islands, U.S.", "dialCode": "1340", "iso2": "VI" },
